...
namespace ObligatorioP3.Controllers
{
    ...
    {
        RepositorioHome_EF repositorioH = new RepositorioHome_EF();
        RepositorioUsuario_EF repositorioU = new RepositorioUsuario_EF();
        ...
        public IActionResult Precarga()
        {
            ...
            ViewBag.Mensaje = repositorioH.PrecargaUsuarios();
            return View("Index");
        }
        ...
        public IActionResult VerificacionLogin(string mail, string password)
        {
            ...
            {
                if (repositorioU.ValidarUsuario(mail, password))
                {
